...
describe('move', () => {
  ...
  it('throws error if given file does not exists', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
    ...
    expect(() => move(list, '6', '1')).toThrow('File not found');
  });

  it('throws error if given destination folder does not exists', () => {
    const list = [
      {
        id: '1',
        name: 'Folder 1',
    ...
    expect(() => move(list, '2', '6')).toThrow('Destination folder not found');
  });
});
